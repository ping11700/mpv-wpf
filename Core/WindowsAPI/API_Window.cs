...
public static class API_Window
{
    ...
    public static Window VisualWindow => Application.Current.Windows.OfType<Window>().FirstOrDefault(x => x.IsVisible);

    public static Window MainWindow => Application.Current.MainWindow;


    public static Window ActiveWindow => Application.Current.Windows.OfType<Window>().FirstOrDefault(x => x.IsActive);
