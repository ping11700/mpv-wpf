...
/// Taskbar api
/// </summary>
//参考: https://www.cnblogs.com/crwy/p/10091034.html
[SuppressUnmanagedCodeSecurity]
public class API_Taskbar
{
    ...
    /// to display progress.
    /// </summary>
    private static readonly IntPtr _ownerHandle = IntPtr.Zero;
    ...
    {
        if (IsPlatformSupported && _ownerHandle != IntPtr.Zero)
    ...
    {
        if (IsPlatformSupported && _ownerHandle != IntPtr.Zero)
            TaskbarList.Instance.SetProgressState(_ownerHandle, (TaskbarProgressBarStatus)state);
    }
...
public enum TaskbarProgressBarState
{
    ...
    /// <summary>
    /// The progress is indeterminate (marquee). 走马灯
    /// </summary>
    Indeterminate = 0x1,
